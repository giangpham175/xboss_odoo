    ...
    def onchange_use_insurance(self):
        ...
        if self.categ_types == 'charge':
            res['domain'] = {'product_id': [
                ('sale_ok', '=', True), '&', ('type', '=', 'service'), ('categ_charge', '=', True)]}
        elif self.categ_types == 'services':
            res['domain'] = {'product_id': [
                ('sale_ok', '=', True), '&', ('type', '=', 'service'), ('categ_service', '=', True)]}
        elif self.categ_types == 'assets':
            res['domain'] = {'product_id': [
                ('sale_ok', '=', True), '&', ('type', '=', 'consu'), ('categ_assets', '=', True)]}
        else:
            res['domain'] = {'product_id': [('sale_ok', '=', True), '&', ('type', '=', [
